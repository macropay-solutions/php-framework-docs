---
title: Strings
description: String manipulation and fluent string utilities in PHP Framework.
context: strings
---
# Strings
...
Framework includes a variety of functions for manipulating string values. Many of these functions are used by the framework itself; however, you are free to use them in your own applications if you find them convenient.
...
The `Str::inlineMarkdown` method converts GitHub flavored Markdown into inline HTML using [CommonMark](https://commonmark.thephpleague.com/). However, unlike the `markdown` method, it does not wrap all generated HTML in a block-level element:
    ...
    $html = Str::inlineMarkdown('**Framework**');
...
The `Str::markdown` method converts GitHub flavored Markdown into HTML using [CommonMark](https://commonmark.thephpleague.com/):
    ...
    $html = Str::markdown('# Framework');

    // <h1>Framework</h1>

    $html = Str::markdown('# Surname <b>Name</b>', [
        'html_input' => 'strip',
    ]);
...
The `Str::plural` method converts a singular word string to its plural form. This function supports [any of the languages support by Framework's pluralizer](/localization#pluralization-language):
...
The `Str::pluralStudly` method converts a singular word string formatted in studly caps case to its plural form. This function supports [any of the languages support by Framework's pluralizer](/localization#pluralization-language):
...
The `replace` method also accepts a `caseSensitive` argument. By default, the `replace` method is case sensitive:
    ...
    Str::replace('Framework', 'Framework', caseSensitive: false);
...
The `Str::replaceStart` method replaces the first occurrence of the given value only if the value appears at the start of the string:
    ...
    $replaced = Str::replaceStart('Hello', 'Framework', 'Hello World');

    // Framework World

    $replaced = Str::replaceStart('World', 'Framework', 'Hello World');
...
The `Str::replaceEnd` method replaces the last occurrence of the given value only if the value appears at the end of the string:
    ...
    $replaced = Str::replaceEnd('World', 'Framework', 'Hello World');

    // Hello Framework

    $replaced = Str::replaceEnd('Hello', 'Framework', 'Hello World');
...
The `Str::singular` method converts a string to its singular form. This function supports [any of the languages support by Framework's pluralizer](/localization#pluralization-language):
...
The `Str::slug` method generates a URL friendly "slug" from the given string:
    ...
    $slug = Str::slug('Framework 5 Framework', '-');
...
The `Str::squish` method removes all extraneous white space from a string, including extraneous white space between words:
    ...
    $string = Str::squish('    framework    framework    ');
...
The `Str::substr` method returns the portion of string specified by the start and length parameters:
    ...
    $converted = Str::substr('The Framework Framework', 4, 7);
...
If you would like to retrieve a `MacropaySolutions\Kernel\Support\Carbon` date instance representing the date and time that a given ULID was created, you may use the `createFromId` method provided by Framework's Carbon integration:
...
The `Str::unwrap` method removes the specified strings from the beginning and end of a given string:
    ...
    Str::unwrap('-Framework-', '-');

    // Framework

    Str::unwrap('{framework: "Framework"}', '{', '}');
...
The `Str::wrap` method wraps the given string with an additional string or pair of strings:
    ...
    Str::wrap('is', before: 'This ', after: ' Framework!');
...
The `exactly` method determines if the given string is an exact match with another string:
    ...
    $result = Str::of('Framework')->exactly('Framework');
...
The `headline` method will convert strings delimited by casing, hyphens, or underscores into a space delimited string with each word's first letter capitalized:
    ...
    $headline = Str::of('surname_name')->headline();
...
The `inlineMarkdown` method converts GitHub flavored Markdown into inline HTML using [CommonMark](https://commonmark.thephpleague.com/). However, unlike the `markdown` method, it does not wrap all generated HTML in a block-level element:
    ...
    $html = Str::of('**Framework**')->inlineMarkdown();
...
The `isEmpty` method determines if the given string is empty:
    ...
    $result = Str::of('Framework')->trim()->isEmpty();
...
The `isNotEmpty` method determines if the given string is not empty:
    ...
    $result = Str::of('Framework')->trim()->isNotEmpty();
...
The `length` method returns the length of the given string:
    ...
    $length = Str::of('Framework')->length();
...
The `markdown` method converts GitHub flavored Markdown into HTML:
    ...
    $html = Str::of('# Framework')->markdown();

    // <h1>Framework</h1>

    $html = Str::of('# Surname <b>Name</b>')->markdown([
        'html_input' => 'strip',
    ]);
...
If you specify a matching group within the expression, Framework will return a collection of that group's matches:
...
The `isMatch` method will return `true` if the string matches a given regular expression:
    ...
    $result = Str::of('framework')->isMatch('/foo (.*)/');
...
The `newLine` method appends an "end of line" character to a string:
    ...
    $padded = Str::of('Framework')->newLine()->append('Framework');
...
The `pipe` method allows you to transform the string by passing its current value to the given callable:
    ...
    $hash = Str::of('Framework')->pipe('md5')->prepend('Checksum: ');
...
The `plural` method converts a singular word string to its plural form. This function supports [any of the languages support by Framework's pluralizer](/localization#pluralization-language):
...
The `prepend` method prepends the given values onto the string:
    ...
    $string = Str::of('Framework')->prepend('Framework ');
...
The `replace` method replaces a given string within the string:
    ...
    $replaced = Str::of('Framework 6.x')->replace('6.x', '7.x');
...
The `replaceStart` method replaces the first occurrence of the given value only if the value appears at the start of the string:
    ...
    $replaced = Str::of('Hello World')->replaceStart('Hello', 'Framework');

    // Framework World

    $replaced = Str::of('Hello World')->replaceStart('World', 'Framework');
...
The `replaceEnd` method replaces the last occurrence of the given value only if the value appears at the end of the string:
    ...
    $replaced = Str::of('Hello World')->replaceEnd('World', 'Framework');

    // Hello Framework

    $replaced = Str::of('Hello World')->replaceEnd('Hello', 'Framework');
...
The `singular` method converts a string to its singular form. This function supports [any of the languages support by Framework's pluralizer](/localization#pluralization-language):
...
The `slug` method generates a URL friendly "slug" from the given string:
    ...
    $slug = Str::of('Framework Framework')->slug('-');
...
The `squish` method removes all extraneous white space from a string, including extraneous white space between words:
    ...
    $string = Str::of('    framework    framework    ')->squish();
...
The `stripTags` method removes all HTML and PHP tags from a string:
    ...
    $result = Str::of('<a href="https://domain.com">Surname <b>Name</b></a>')->stripTags();

    // Surname Name

    $result = Str::of('<a href="https://domain.com">Surname <b>Name</b></a>')->stripTags('<b>');
...
The `substr` method returns the portion of the string specified by the given start and length parameters:
    ...
    $string = Str::of('Framework Framework')->substr(8);

    // Framework

    $string = Str::of('Framework Framework')->substr(8, 5);
...
The `substrReplace` method replaces text within a portion of a string, starting at the position specified by the second argument and replacing the number of characters specified by the third argument. Passing `0` to the method's third argument will insert the string at the specified position without replacing any of the existing characters in the string:
    ...
    $string = Str::of('The Framework')->substrReplace(' Framework', 3, 0);
...
The `test` method determines if a string matches the given regular expression pattern:
    ...
    $result = Str::of('Framework Framework')->test('/Framework/');
...
The `toBase64` method converts the given string to Base64:
    ...
    $base64 = Str::of('Framework')->toBase64();
...
The `unwrap` method removes the specified strings from the beginning and end of a given string:
    ...
    Str::of('-Framework-')->unwrap('-');

    // Framework

    Str::of('{framework: "Framework"}')->unwrap('{', '}');
...
The `upper` method converts the given string to uppercase:
    ...
    $adjusted = Str::of('framework')->upper();
...
The `whenEmpty` method invokes the given closure if the string is empty. If the closure returns a value, that value will also be returned by the `whenEmpty` method. If the closure does not return a value, the fluent string instance will be returned:
    ...
    $string = Str::of('  ')->whenEmpty(function (Stringable $string) {
        return $string->trim()->prepend('Framework');
    });
...
The `whenNotEmpty` method invokes the given closure if the string is not empty. If the closure returns a value, that value will also be returned by the `whenNotEmpty` method. If the closure does not return a value, the fluent string instance will be returned:
    ...
    $string = Str::of('Framework')->whenNotEmpty(function (Stringable $string) {
        return $string->prepend('Framework ');
    });
...
The `whenExactly` method invokes the given closure if the string exactly matches the given string. The closure will receive the fluent string instance:
    ...
    $string = Str::of('framework')->whenExactly('framework', function (Stringable $string) {
        return $string->title();
    });
...
The `whenNotExactly` method invokes the given closure if the string does not exactly match the given string. The closure will receive the fluent string instance:
    ...
    $string = Str::of('framework')->whenNotExactly('framework', function (Stringable $string) {
        return $string->title();
    });
...
The `whenIsAscii` method invokes the given closure if the string is 7 bit ASCII. The closure will receive the fluent string instance:
    ...
    $string = Str::of('framework')->whenIsAscii(function (Stringable $string) {
        return $string->title();
    });
...
The `whenTest` method invokes the given closure if the string matches the given regular expression. The closure will receive the fluent string instance:
    ...
    $string = Str::of('framework framework')->whenTest('/framework/', function (Stringable $string) {
        return $string->title();
    });
